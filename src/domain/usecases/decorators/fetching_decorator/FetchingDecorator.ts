...
> implements UseCase<InferableDispatchInputData<I>, O, E> {
  ...
  constructor(useCase: UseCase<InferableInputData<I>, O, E>, fetchingController: FetchingController) {
    this.useCase = useCase;
    this.fetchingController = fetchingController;
  }

  execute(inputData: InferableDispatchInputData<I>, callbacks: UseCaseCallbacks<O, E>) {
